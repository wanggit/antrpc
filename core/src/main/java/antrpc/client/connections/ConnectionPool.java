...
public class ConnectionPool {
    ...
    private void initPool(final int cnt) {
        if (log.isInfoEnabled()) {
            log.info("Initialize " + cnt + " connections.");
        }
        final ExecutorService fixedThreadPool = Executors.newFixedThreadPool(cnt);
        final List<Future<Connection>> futures = new ArrayList<Future<Connection>>();
